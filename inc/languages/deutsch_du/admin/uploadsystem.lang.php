...
$l['uploadsystem_manage_overview'] = "Upload-Elemente";
$l['uploadsystem_manage_overview_desc'] = "In diesem Bereich kannst du die Upload-Elemente erstellen, verwalten und löschen.";
$l['uploadsystem_manage_overview_name'] = "Name";
$l['uploadsystem_manage_overview_path'] = "Upload-Pfad";
$l['uploadsystem_manage_overview_extensions'] = "erlaubte	Dateitypen";
$l['uploadsystem_manage_overview_dims'] = "Größe (Breite x Höhe)";
$l['uploadsystem_manage_overview_dims_min'] = "<b>min.</b> {1} Pixel<br><b>max.</b> /";
$l['uploadsystem_manage_overview_dims_minmax'] = "<b>min.</b> {1} Pixel<br><b>max.</b> {2} Pixel";
$l['uploadsystem_manage_overview_dims_fix'] = "{1} Pixel";
$l['uploadsystem_manage_overview_square'] = "Quadratisch";
$l['uploadsystem_manage_overview_square_yes'] = "Ja";
$l['uploadsystem_manage_overview_square_no'] = "Nein";
$l['uploadsystem_manage_overview_size'] = "max. Dateigröße";
$l['uploadsystem_manage_overview_options'] = "Optionen";
$l['uploadsystem_manage_overview_options_edit'] = "Bearbeiten";
$l['uploadsystem_manage_overview_options_delete'] = "Löschen";
...
$l['uploadsystem_manage_edit_element'] = "Upload-Element bearbeiten";
$l['uploadsystem_manage_edit_element_desc'] = "Hier kannst du ein Upload-Element bearbeiten.";
$l['uploadsystem_manage_edit_element_container'] = "Upload-Element: {1}";
$l['uploadsystem_manage_edit_element_button'] = "Änderungen speichern";
$l['uploadsystem_manage_edit_element_logadmin'] = "Upload-Element geändert ";
...
$l['uploadsystem_manage_edit_user_element_dims_maxmin'] = "Die Datei kann eine Größe von {1} bis {2} Pixel besitzen.";
$l['uploadsystem_manage_edit_user_element_dims_min'] = "Die <i>minimal</i> zulässige Größe beträgt {1} Pixel.";
$l['uploadsystem_manage_edit_user_element_dims_one'] = "Die zulässige Größe beträgt {1} Pixel.";
$l['uploadsystem_manage_edit_user_element_square'] = "Die Datei muss <b>quadratisch</b> sein.";
$l['uploadsystem_manage_edit_user_element_extensions_plural'] = "Es sind {1} -Dateien zulässig.";
$l['uploadsystem_manage_edit_user_element_extensions_singular'] = "Nur {1} Dateien sind zulässig.";
$l['uploadsystem_manage_edit_user_element_size'] = "Die maximal zulässige Dateigröße beträgt {1}.";
$l['uploadsystem_manage_edit_user_element_notice'] = "Wenn du ein anderes Bild wählst, wird das ältere Bild vom Server gelöscht.";

$l['uploadsystem_manage_edit_user_element_button_add'] = "{1} hochladen";
$l['uploadsystem_manage_edit_user_element_button_change'] = "{1} ändern";
$l['uploadsystem_manage_edit_user_element_button_remove'] = "{1} löschen";

$l['uploadsystem_manage_edit_user_error_upload'] = "Es wurde keine Datei zum hochladen ausgewählt, bitte wähle eine Datei aus um sie hochzuladen.";
$l['uploadsystem_manage_edit_user_error_upload_dims_fixed'] = "Die Datei entspricht nicht den zugelassenen Maßen von {1}x{2} Pixel (Breite x Höhe).";
$l['uploadsystem_manage_edit_user_error_upload_dims_square'] = "Die Datei ist nicht quadratisch. Bitte wähle eine quadratische Datei aus.";
$l['uploadsystem_manage_edit_user_error_upload_dims_squareMini'] = "Die Datei ist zu klein und nicht quadratisch. Die minimal zulässige Größe beträgt {1}x{2} Pixel (Breite x Höhe).";
$l['uploadsystem_manage_edit_user_error_upload_dims_squareMax'] = "Die Datei ist zu groß und nicht quadratisch. Die maximal zulässige Größe beträgt {1}x{2} Pixel (Breite x Höhe).";
$l['uploadsystem_manage_edit_user_error_upload_dims_mini'] = "Die Datei ist zu klein. Die minimal zulässige Größe beträgt {1}x{2} Pixel (Breite x Höhe).";
$l['uploadsystem_manage_edit_user_error_upload_dims_max'] = "Die Datei ist zu groß. Die maximal zulässige Größe beträgt {1}x{2} Pixel (Breite x Höhe).";
